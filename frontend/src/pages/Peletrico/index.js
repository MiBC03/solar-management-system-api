...
function Peletrico(){
    ...
    function deletePeletrico(clt_codigo) {
            ...
            <Container>
                ...
                <Col className='col-12'>
                    ...
                    <div className=" shadow p-5 m-5 bg-white">
                        ...
                        <h3 className='fw-lighter'>Projetos Elétricos</h3>
                        <hr className="pb-3"></hr>
                            ...
                            <Col className="d-flex justify-content-end">
                                <Button href="/peletrico/create" variant="outline-primary" size="sm"><AiOutlineUserAdd className="mb-1"/> Cadastro </Button>
                            </Col>
                        ...
                        <Table size="sm">
                            ...
                            <tr key={cliente.id}>
                                ...
                                <td>
                                    <Button variant="outline-danger"  size="sm" onClick={ () => deletePeletrico(cliente.id)}>
