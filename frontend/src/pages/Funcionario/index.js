...
function Funcionario(){
    ...
    function deleteFuncionario(clt_codigo) {
                    ...
                    <div className=" shadow p-5 m-5 bg-white">
                        ...
                        <hr className="pb-3"></hr>
                            ...
                            <Col className="d-flex justify-content-end">
                                <Button href="/funcionario/create" variant="outline-primary" size="sm"><AiOutlineUserAdd className="mb-1"/> Cadastro </Button>
                            </Col>
                        ...
                        <Table size="sm">
                            ...
                            <tr key={cliente.id}>
                                ...
                                <td>
                                    <Button variant="outline-danger"  size="sm" onClick={ () => deleteFuncionario(cliente.id)}>
